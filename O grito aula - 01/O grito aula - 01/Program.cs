...
namespace O_grito_aula___01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //if (valor2)
            //{
            //    Console.WriteLine("Valor 2 estava verdadeiro");
            //}
            //else
            //{
            //    Console.WriteLine("Valor 1 estava verdadeiro");
            //}
            ...
            //Console.WriteLine(notVerdadeiro);
            //Console.WriteLine(notFalso);
            //Console.WriteLine(ou1);
            //Console.WriteLine(ou2);
            //Console.WriteLine(ou3);
            //Console.WriteLine(ou4);
